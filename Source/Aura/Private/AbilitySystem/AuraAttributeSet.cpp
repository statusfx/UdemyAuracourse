...
{
	//TODO: Move this at some point to the post Gameplay Effect section. Waiting for instructor to show best practices. 
...
void UAuraAttributeSet::OnRep_CriticalHitDamage(const FGameplayAttributeData& OldCriticalHitResistance) const
{
